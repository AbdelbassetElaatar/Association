...
<form action="Logincheck.php" method="post">
  <div class="form-group">
    ...
    <input type="email" class="form-control "  name='email' style="width:70%" aria-describedby="emailHelp" placeholder="Entrer email">
  </div>
  <div class="form-group">
    <label >Mot de passe</label>
    <input type="password" name="password" class="form-control " style="width:70%" placeholder="Mot de passe">
  </div>
